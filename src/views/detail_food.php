          ...
          <div class="row">
              <div class="col-md-4 text-center">
                   <?php 
                        ...
                        ?>
                            <img style="max-height: 300px;min-width: 400px" src="/images/food/<?php echo $food->image_name; ?>" alt="Chicke Hawain Pizza" class="img-responsive img-curve img-fluid">
                            ...
                            <div class="col-md-2">
                                <h4>Số lượng:</h4>
                                    ...
                                    <div class="col-md-5 mt-3 pt-2">
                                        <input class="form-control btn-success rounded border p-2 " type="submit" name="addcart" value="Đặt hàng">
                                    </div> 
