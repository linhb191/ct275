...
<body>
    ...
    <form action="<?= $router->generate('admin.createfood') ?>" method="POST" enctype="multipart/form-data"
        class="m-3 p-2">
        <div class="mb-3 row justify-content-center">
            <label for="inputTen" class="col-sm-2 col-form-label">Tên:</label>
            <div class="col-sm-6">
                <input type="text" name="title" placeholder="Nhập tên sản phẩm" class="form-control" id="inputTen"
                    required>
            </div>
        </div>
        <div class="mb-3 row justify-content-center">
            ...
            <div class="col-sm-6">
                <textarea name="description" cols="30" rows="5" placeholder="Description of the food."
                    class="form-control" id="inputDescription" required></textarea>
            </div>
        </div>
        <div class="mb-3 row justify-content-center">
