...
<body>
    ...
    <form action="<?= $router->generate('admin.editcategory') ?>" method="POST" enctype="multipart/form-data"
        class="m-3 p-2">
        ...
        <div class="mb-3 row justify-content-center">
            ...
            <div class="col-sm-6 form-check form-check-inline">
                <div class="form-check form-check-inline">
                    <input <?php if( $category->featured =="Yes"){echo "checked";}?> name="featured"
                        class="form-check-input" type="radio" id="inlineCheckbox1" value="Yes">
                    <label class="form-check-label" for="inlineCheckbox1">Yes</label>
                </div>
                <div class="form-check form-check-inline">
                    <input <?php if( $category->featured =="No"){echo "checked";}?> name="featured"
                        class="form-check-input" type="radio" id="inlineCheckbox2" value="No">
        ...
        <div class="mb-3 row justify-content-center">
            ...
            <div class="col-sm-6 form-check form-check-inline">
                <div class="form-check form-check-inline">
                    <input <?php if( $category->active =="Yes"){echo "checked";}?> name="active"
                        class="form-check-input" type="radio" id="inlineCheckbox1" value="Yes">
                    <label class="form-check-label" for="inlineCheckbox1">Yes</label>
                </div>
                <div class="form-check form-check-inline">
                    <input <?php if($category->active=="No"){echo "checked";}?> name="active" class="form-check-input"
