...
<body>
    ...
    <form action="<?= $router->generate('admin.editfood') ?>" method="POST" enctype="multipart/form-data"
        class="m-3 p-2">
        <div class="mb-3 row justify-content-center">
            <label for="inputTen" class="col-sm-2 col-form-label">Tên sản phẩm:</label>
            <div class="col-sm-6">
                <input type="text" name="title" value="<?php echo $food->title;?>" class="form-control" id="inputTen"
                    required>
            </div>
        </div>
        <div class="mb-3 row justify-content-center">
            ...
            <div class="col-sm-6">
                <textarea name="description" cols="30" rows="5" class="form-control" id="inputDes"
        ...
        <div class="mb-3 row justify-content-center">
            ...
            <div class="col-sm-6">
                <input type="number" name="price" value="<?php echo $food->price;?>" class="form-control"
        ...
        <div class="mb-3 row justify-content-center">
            ...
            <div class="col-sm-6">
                <input type="file" name="image" value="<?php echo $food->price;?>" class="form-control"
                    id="inputNewimage">
            </div>
        </div>
        <div class="mb-3 row justify-content-center">
            ...
            <div class="col-sm-6">
                <select name="category" class="form-select">
                    ...
                    <option <?php if($food->category_id == $category->id){echo "selected";} ?>
        ...
        <div class="mb-3 row justify-content-center">
            ...
            <div class="col-sm-6 form-check form-check-inline">
                <div class="form-check form-check-inline">
                    <input <?php if($food->featured=="Yes"){echo "checked";}?> name="featured" class="form-check-input"
                        type="radio" id="inlineCheckbox1" value="Yes">
                    <label class="form-check-label" for="inlineCheckbox1">Yes</label>
                </div>
                <div class="form-check form-check-inline">
                    <input <?php if($food->featured=="No"){echo "checked";}?> name="featured" class="form-check-input"
                        type="radio" id="inlineCheckbox2" value="No">
        ...
        <div class="mb-3 row justify-content-center">
            ...
            <div class="col-sm-6 form-check form-check-inline">
                <div class="form-check form-check-inline">
                    <input <?php if($food->active=="Yes"){echo "checked";}?> name="active" class="form-check-input"
                        type="radio" id="inlineCheckbox1" value="Yes">
                    <label class="form-check-label" for="inlineCheckbox1">Yes</label>
                </div>
                <div class="form-check form-check-inline">
                    <input <?php if($food->active=="No"){echo "checked";}?> name="active" class="form-check-input"
                        type="radio" id="inlineCheckbox2" value="No">
                    <label class="form-check-label" for="inlineCheckbox2">No</label>
                </div>
            </div>
            ...
            <div class="mb-3 row justify-content-center">
                <div class="offset-sm-2 col-sm-6">
                    ...
                    <input type="submit" name="submit" value="Cập nhật sản phẩm"
                        class="btn-secondary bg-primary form-control">
                </div>
            </div>
    </form>
