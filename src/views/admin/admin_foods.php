    ...
    <div class="container">
        <div class="row content">
            ...
            <div class="col-sm-9 pt-3" style="background-color: hsla(89, 43%, 51%, 0.3);">
                ...
                <hr>
                <div class="my-4">
                    <a href="/admin_food/add"><button class="btn-primary border p-2" style="width: 100px;">Thêm
                            bánh</button></a>
                </div>
                <table class="table table-success table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $food->active?></td>
                            <td>
                                <a href="/admin_food/edit/<?= $food->id?>"><button class="btn-secondary border p-2">Cập
                                        nhật</button></a>
