...
<body>
    ...
    <form action="<?= $router->generate('admin.createcategory') ?>" method="POST" enctype="multipart/form-data"
        class="m-3 p-2">
        ...
        <div class="mb-3 row justify-content-center">
            <div class="offset-sm-2 col-sm-6">
                <input type="submit" name="add_category" class="form-control btn-secondary bg-primary form-control"
                    value="Thêm">
            </div>
        </div>
    </form>
